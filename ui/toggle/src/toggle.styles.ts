...
export const shapeSmallSizeHandleStyles: styleFn = () => ({
  width: 36,
  height: 20,
})

export const shapeSmallSizeThumbStyles: styleFn = () => ({
  width: 16,
  height: 16,
})

export const shapeMediumSizeHandleStyles: styleFn = () => ({
  width: 44,
  height: 24,
})

export const shapeMediumSizeThumbStyles: styleFn = () => ({
  width: 20,
  height: 20,
})
...
export const shapeHandleStyles = switchProp(prop('size', 'small'), {
  small: shapeSmallSizeHandleStyles,
  medium: shapeMediumSizeHandleStyles,
})

export const shapeThumbStyles = switchProp(prop('size', 'small'), {
  small: shapeSmallSizeThumbStyles,
  medium: shapeMediumSizeThumbStyles,
})
